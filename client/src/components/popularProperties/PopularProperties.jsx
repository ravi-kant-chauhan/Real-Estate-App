    ...
    <div className={classes.container}>
      <div className={classes.wrapper}>
        ...
        <div className={classes.properties}>
          <Link to={`/propertyType?type=beach`} className={classes.property}>
            <img src={img1} />
            <div className={classes.quantity}>{beachProperties} properties</div>
            <h5>Beach properties</h5>
          </Link>
          <Link to={`/propertyType?type=mountain`} className={classes.property}>
            <img src={img2} />
            <div className={classes.quantity}>{mountainProperties} properties</div>
            <h5>Mountain properties</h5>
          </Link>
          <Link to={`/propertyType?type=village`} className={classes.property}>
            <img src={img3} />
